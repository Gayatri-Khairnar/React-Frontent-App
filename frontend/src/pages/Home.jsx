    ...
    <>
      ...
      <section className='hero__section pt-[60px] 2xl:h-[800px]'>
        <div className='container'>
          <div className='flex flex-col lg:flex-row gap-[90px] items-center hustify-between'>
            {/* ============== hero content ================ */}
            <div>
              <div className='lg:w-[560px]'>
                ...
                <p className='text__para'>
                  ...
                  Rem totam cupiditate tempora, iusto ex minima vel quaerat at doloribus,
                  nobis rerum quis blanditiis laborum nam odit eum. Sit, similique doloremque.
                </p>
